...
class MVGRL(nn.Module):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        self.encoder1 = GraphConv(in_dim, out_dim, norm='both', bias=True, activation=nn.PReLU(),allow_zero_in_degree=True)
        self.encoder2 = GraphConv(in_dim, out_dim, norm='none', bias=True, activation=nn.PReLU(),allow_zero_in_degree=True)
