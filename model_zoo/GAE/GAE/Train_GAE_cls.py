...
def Train_GAE_cls(margs):
    ...
    in_channels, out_channels = dataset.num_features, 32 # GAE: [Cora Citeseer] 64  [Citeseer0.0] 64  Pubmed 64        VGAE: Cora 128 Citeseer 64 Pubmed 256
    # nettack GAE Cora 16
    # nettack GAE Citeseer 128
    # nettack VGAE Citeseer 32
