...
def node_classification_evaluation(data, x, labels, num_classes, lr_f, weight_decay_f, max_epoch_f, device ,mute=False):
    ...
    final_acc, estp_acc = linear_probing_for_transductive_node_classiifcation(encoder, data, x, labels, optimizer_f, max_epoch_f, device, mute)
...
def linear_probing_for_transductive_node_classiifcation(model, graph, feat, labels, optimizer, max_epoch, device, mute=True):
