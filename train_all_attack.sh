...
for i in 'random' 'DICE' 'heuristic' 'Meta_Self' 
do
    if [ $i == 'Meta_Self' ]
    then
        for ptb in 0.25
        do
            CUDA_VISIBLE_DEVICES=${CUDA_USE[$n]} python Train_Runner.py --dataset "Attack-$2"  --attack  "$i-$ptb" --mode $3 --model_name $1 >"./logs/A800_$1_Compare/$1_${i}_$2_${ptb}_$3_a800.file" &
