...
class CoraMLUnitDGL(torch.utils.data.Dataset):  # Adaptive attack model
...
class CoraMLUnitDataset(torch.utils.data.Dataset):
...
if __name__ == '__main__':
    dataset = CoraMLUnitDataset() # 这个貌似就是cora不是cora ml
